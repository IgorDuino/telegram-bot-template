...
from commands import owner_commands, users_commands
import config
from keyboards.inline import get_author_keyboard
...
async def about_handler(message: Message, bot: Bot):
    ...
    await message.answer(
        ...
        reply_markup=get_author_keyboard(owner_id=config.owner_id),
    )
